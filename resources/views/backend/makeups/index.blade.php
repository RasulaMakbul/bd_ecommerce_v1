<x-backend.master>
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            ...
            <a class="btn btn-sm btn-outline-secondary" aria-current="page" href="{{route('makeup.create')}}">
    ...
    <table class="table table-bordered table-hover align-middle">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{route('makeup.show',$makeup->id)}}" class="btn btn-sm link-info"><i class="fa-solid fa-eye fs-5"></i></a>
                    <a href="{{route('makeup.edit',$makeup->id)}}" class="btn btn-sm link-warning"><i class="fa-solid fa-pen-to-square fs-5"></i></a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form action="{{ route('makeup.destroy', $makeup->id) }}" method="post" style="display:inline">
                                        @csrf
                                        @method('delete')
